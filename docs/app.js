...
;require.register("Verify.js", function(exports, require, module) {
"use strict";function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.Verify=void 0;var _View2=require("curvature/base/View"),_Application=require("./Application"),_Strings=require("./Strings");function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),Object.defineProperty(a,"prototype",{writable:!1}),a}function _inherits(a,b){if("function"!=typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),Object.defineProperty(a,"prototype",{writable:!1}),b&&_setPrototypeOf(a,b)}function _setPrototypeOf(a,b){return _setPrototypeOf=Object.setPrototypeOf||function(a,b){return a.__proto__=b,a},_setPrototypeOf(a,b)}function _createSuper(a){var b=_isNativeReflectConstruct();return function(){var c,d=_getPrototypeOf(a);if(b){var e=_getPrototypeOf(this).constructor;c=Reflect.construct(d,arguments,e)}else c=d.apply(this,arguments);return _possibleConstructorReturn(this,c)}}function _possibleConstructorReturn(a,b){if(b&&("object"===_typeof(b)||"function"==typeof b))return b;if(void 0!==b)throw new TypeError("Derived constructors may only return object or undefined");return _assertThisInitialized(a)}function _assertThisInitialized(a){if(void 0===a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return a}function _isNativeReflectConstruct(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(a){return!1}}function _getPrototypeOf(a){return _getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(a){return a.__proto__||Object.getPrototypeOf(a)},_getPrototypeOf(a)}var Verify=/*#__PURE__*/function(a){function b(a,d){var e;_classCallCheck(this,b),e=c.call(this,a,d),e.template="<h1>Verify Message</h1>\n<p>[[status]]</p>\n<p>address: <input cv-bind = \"address\"></p>\n<p>msg: <input cv-bind = \"message\"></p>\n<p>sig: <input cv-bind =\"signature\"></p>\n<p><button cv-on = \"click:onVerifyClicked(event)\">verify</button></p>",_Application.Application.ethereum||(e.args.status=_Application.Application.ERROR_NOTFOUND_WEB3),e.args.message=null,e.args.address=null,e.args.signature=null;var f=_Application.Application.bindTo("userAddress",function(a){e.args.address=a}),g=_Application.Application.bindTo("signature",function(a){e.args.signature=a}),h=_Application.Application.bindTo("message",function(a){e.args.message=a});return e.onRemove(f),e.onRemove(h),e}_inherits(b,a);var c=_createSuper(b);return _createClass(b,[{key:"onVerifyClicked",value:function onVerifyClicked(){var a=this;this.args.status="...",_Application.Application.verify(this.args.message,this.args.signature).then(function(b){a.args.status=(a.args.address+"").toLowerCase()===(b+"").toLowerCase()?_Strings.Strings.MSG_SIG_VERIFIED(b):String.ERR_SIG_INVALID()})}}]),b}(_View2.View);exports.Verify=Verify;
});

;require.register("client.js", function(exports, require, module) {
"use strict";var Login=require("./Login").Login,Sign=require("./Sign").Sign,Verify=require("./Verify").Verify;window.addEventListener("DOMContentLoaded",function(){new Login().render(document.body),new Sign().render(document.body),new Verify().render(document.body)});
});
