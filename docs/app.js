...
"use strict";function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.FileIndex=void 0;var _Elicit=require("curvature/net/Elicit"),_View2=require("curvature/base/View"),_Tag=require("curvature/base/Tag"),_Application=require("./Application"),_Loader=require("./Loader"),_Strings=require("./Strings"),_Image=require("./media-view/Image"),_Audio=require("./media-view/Audio"),_Video=require("./media-view/Video"),_Doc=require("./media-view/Doc"),_Config=require("./Config");function _slicedToArray(a,b){return _arrayWithHoles(a)||_iterableToArrayLimit(a,b)||_unsupportedIterableToArray(a,b)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(a,b){if(a){if("string"==typeof a)return _arrayLikeToArray(a,b);var c=Object.prototype.toString.call(a).slice(8,-1);return"Object"===c&&a.constructor&&(c=a.constructor.name),"Map"===c||"Set"===c?Array.from(a):"Arguments"===c||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c)?_arrayLikeToArray(a,b):void 0}}function _arrayLikeToArray(a,b){(null==b||b>a.length)&&(b=a.length);for(var c=0,d=Array(b);c<b;c++)d[c]=a[c];return d}function _iterableToArrayLimit(a,b){var c=null==a?null:"undefined"!=typeof Symbol&&a[Symbol.iterator]||a["@@iterator"];if(null!=c){var d,e,f=[],g=!0,h=!1;try{for(c=c.call(a);!(g=(d=c.next()).done)&&(f.push(d.value),!(b&&f.length===b));g=!0);}catch(a){h=!0,e=a}finally{try{g||null==c["return"]||c["return"]()}finally{if(h)throw e}}return f}}function _arrayWithHoles(a){if(Array.isArray(a))return a}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),Object.defineProperty(a,"prototype",{writable:!1}),a}function _inherits(a,b){if("function"!=typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),Object.defineProperty(a,"prototype",{writable:!1}),b&&_setPrototypeOf(a,b)}function _setPrototypeOf(a,b){return _setPrototypeOf=Object.setPrototypeOf||function(a,b){return a.__proto__=b,a},_setPrototypeOf(a,b)}function _createSuper(a){var b=_isNativeReflectConstruct();return function(){var c,d=_getPrototypeOf(a);if(b){var e=_getPrototypeOf(this).constructor;c=Reflect.construct(d,arguments,e)}else c=d.apply(this,arguments);return _possibleConstructorReturn(this,c)}}function _possibleConstructorReturn(a,b){if(b&&("object"===_typeof(b)||"function"==typeof b))return b;if(void 0!==b)throw new TypeError("Derived constructors may only return object or undefined");return _assertThisInitialized(a)}function _assertThisInitialized(a){if(void 0===a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return a}function _isNativeReflectConstruct(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(a){return!1}}function _getPrototypeOf(a){return _getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(a){return a.__proto__||Object.getPrototypeOf(a)},_getPrototypeOf(a)}function _defineProperty(a,b,c){return b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c,a}var FileIndex=/*#__PURE__*/function(a){function b(a,d){var e;return _classCallCheck(this,b),e=c.call(this,a,d),_defineProperty(_assertThisInitialized(e),"template","<div class = \"media-view\" cv-bind = \"mediaView\" cv-on = \"click:closeMediaView;wheel:wheelMediaView:c;\"></div>\n\n<small><pre>[[tokenString]]</pre></small>\n<small class = \"valid-timer\" cv-if = \"validTimer\">Token valid for [[validTimer]]s</small>\n\n<span cv-if = \"files\"><h2>Files</h2></span>\n\n<ul cv-each = \"files:file\">\n\t<li><a cv-link cv-on = \"click:getAsset(event, file)\">[[file]]</a></li>\n</ul>"),_Application.Application.bindTo("token",function(a){a&&fetch("".concat(_Config.Config.mediaGate,"/media")).then(function(a){return a.json()}).then(function(a){return e.args.files=a.map(function(a){return a.replace(/\.\//,"")})})}),e.onFrame(function(){if(!_Application.Application.challenge)return void(e.args.validTimer=0);var a=_Application.Application.challenge.validThru;e.args.validTimer=Math.max(0,a-Date.now()/1e3).toFixed(2),e.args.validTimer||(_Application.Application.solved=!1,e.args.files=[])}),e}_inherits(b,a);var c=_createSuper(b);return _createClass(b,[{key:"getAsset",value:function getAsset(a,b){var c=this;a.preventDefault();var d="Bearer ".concat(JSON.stringify(_Application.Application.token)),e="".concat(_Config.Config.mediaGate,"/media/show?assetPath=").concat(b),f=this.args.mediaView=new _Loader.Loader,g=this.elicit=new _Elicit.Elicit(e,{credentials:"include",headers:{Authorization:d}});g.addEventListener("firstByte",function(){return f.args.forward=!0}),g.addEventListener("paused",function(){return f.args.dlSpeed="Paused "}),g.addEventListener("complete",function(){return setTimeout(function(){c.elicit=null;var a=g.type.split(";").shift(),b=a.split("/"),d=_slicedToArray(b,2),e=d[0],f=d[1];g.objectUrl().then(function(a){"text"===e||"application"===e?c.args.mediaView=new _Doc.Doc({src:a}):"image"===e?c.args.mediaView=new _Image.Image({src:a}):"audio"===e?c.args.mediaView=new _Audio.Audio({src:a}):"video"===e?c.args.mediaView=new _Video.Video({src:a}):(new _Tag.Tag("<a download>").attr({href:a}).click(),c.args.mediaView=null)})})});var h=null;g.addEventListener("progress",function(a){h&&clearTimeout(h),h=c.onTimeout(750,function(){return g.isPaused||(f.args.dlSpeed="0 KBps ")}),g.isPaused||(f.args.received=(a.detail.received/1024).toFixed(0),f.args.length=(g.length/1024).toFixed(0),f.args.done=(100*a.detail.done).toFixed(2),f.args.dlSpeed=1024>g.speed?g.speed.toFixed(2)+" kBps ":(g.speed/1024).toFixed(2)+" MBps ")}),g.addEventListener("fail",function(){c.args.mediaView&&(c.args.mediaView.remove(),c.args.mediaView=null)})}},{key:"closeMediaView",value:function closeMediaView(a){a.target.matches("div.media-view")||(this.elicit&&this.elicit.cancel(),this.args.mediaView&&(this.args.mediaView.remove(),this.args.mediaView=null))}},{key:"wheelMediaView",value:function wheelMediaView(a){a.preventDefault()}}]),b}(_View2.View);exports.FileIndex=FileIndex;
});

;require.register("Loader.js", function(exports, require, module) {
"use strict";function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.Loader=void 0;var _Config=require("curvature/base/Config"),_View2=require("curvature/base/View");function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),Object.defineProperty(a,"prototype",{writable:!1}),a}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _inherits(a,b){if("function"!=typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),Object.defineProperty(a,"prototype",{writable:!1}),b&&_setPrototypeOf(a,b)}function _setPrototypeOf(a,b){return _setPrototypeOf=Object.setPrototypeOf||function(a,b){return a.__proto__=b,a},_setPrototypeOf(a,b)}function _createSuper(a){var b=_isNativeReflectConstruct();return function(){var c,d=_getPrototypeOf(a);if(b){var e=_getPrototypeOf(this).constructor;c=Reflect.construct(d,arguments,e)}else c=d.apply(this,arguments);return _possibleConstructorReturn(this,c)}}function _possibleConstructorReturn(a,b){if(b&&("object"===_typeof(b)||"function"==typeof b))return b;if(void 0!==b)throw new TypeError("Derived constructors may only return object or undefined");return _assertThisInitialized(a)}function _assertThisInitialized(a){if(void 0===a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return a}function _isNativeReflectConstruct(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(a){return!1}}function _getPrototypeOf(a){return _getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(a){return a.__proto__||Object.getPrototypeOf(a)},_getPrototypeOf(a)}var Loader=/*#__PURE__*/function(a){function b(a,d){var e;_classCallCheck(this,b),e=c.call(this,a,d),e.template="<svg viewBox=\"0 0 100 100\">\n\t<ellipse\n\t\tstyle=\"\n\t\t\tstroke-width: 5;\n\t\t\tfill:         none;\n\t\t\tstroke:       [[color]];\n\t\t\"\n\t\tstroke-dasharray = \"314px\"\n\t\tcx               = \"50\"\n\t\tcy               = \"50\"\n\t\trx               = \"47.5\"\n\t\try               = \"47.5\"\n\t>\n\t\t<animateTransform\n\t\t\tattributeName = \"transform\"\n\t\t\tattributeType = \"XML\"\n\t\t\ttype          = \"rotate\"\n\t\t\tfrom          = \"[[rotFrom]] 50 50\"\n\t\t\tto            = \"[[rotTo]] 50 50\"\n\t\t\tdur           = \"[[speed]]s\"\n\t\t\trepeatCount   = \"[[repeatCount]]\"\n\t\t/>\n\t\t<animate\n\t\t\tattributeName = \"stroke-dashoffset\"\n\t\t\tattributeType = \"XML\"\n\t\t\tfrom          = \"[[dashFrom]]px\"\n\t\t\tto            = \"[[dashTo]]px\"\n\t\t\tdur           = \"[[halfSpeed]]s\"\n\t\t\trepeatCount   = \"[[repeatCount]]\"\n\t\t/>\n\t</ellipse>\n</svg>\n<div cv-if = \"received\" class = \"loader-progress\">\n\t<p>[[received]] KB / [[length]] KB</p>\n\t<p>[[dlSpeed]][[done]]%</p>\n</div>\n<div cv-if = \"!received\" class = \"loader-progress\">\n\t<pre>   Waiting for Server[[elipsis]]</pre>\n</div>\n",e.args.repeatCount="indefinite",e.args.color="#FFF",e.args.speed=.333,e.args.dlSpeed=0,e.args.received=0,e.args.length=0,e.args.done=0,e.args.bindTo("speed",function(a){e.args.halfSpeed=3*a}),e.args.forward=!1,e.args.bindTo("forward",function(a){return a?void(e.args.rotFrom=0,e.args.rotTo=360,e.args.dashFrom=0,e.args.dashTo=628,e.args.speed=.333):(e.args.rotFrom=360,e.args.rotTo=0,e.args.dashFrom=628,void(e.args.dashTo=0))});var f=0;return e.args.elipsis="   ",e.onInterval(250,function(){var a=++f%4;e.args.elipsis=".".repeat(a)+" ".repeat(3-a)}),e}_inherits(b,a);var c=_createSuper(b);return _createClass(b)}(_View2.View);exports.Loader=Loader;
});
